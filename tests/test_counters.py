...
def test_inc_number_letter_counter():
    ...
    assert ctr.letter_value == 'Y'
    assert ctr.number_value == '8'
    assert ctr.inc_number_value == 'Y9'
    assert ctr.letter_value == 'Y'
    assert ctr.number_value == '9'
    assert ctr.inc_letter_value == 'Z9'
    assert ctr.letter_value == 'Z'
    assert ctr.number_value == '9'
    assert ctr.inc_number_value == 'Z10'
    assert ctr.letter_value == 'Z'
    assert ctr.number_value == '10'
    assert ctr.inc_letter_value == 'AA10'
    assert ctr.letter_value == 'AA'
    assert ctr.number_value == '10'
    assert ctr.inc_number_value == 'AA11'
    assert ctr.letter_value == 'AA'
    assert ctr.number_value == '11'
    assert ctr.inc_letter_value == 'AB11'
    assert ctr.letter_value == 'AB'
    assert ctr.number_value == '11'
    assert ctr.inc_number_value == 'AB12'
    assert ctr.letter_value == 'AB'
    assert ctr.number_value == '12'
    assert ctr.inc_letter_value == 'AC12'
    assert ctr.letter_value == 'AC'
    assert ctr.number_value == '12'
